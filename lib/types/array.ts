...
type TArrayParser = TValueParser<any[]>;

const createArrayParser = ({ elementType, length, endianness }: { elementType: TFieldType, length: number, endianness: TEndianness }): TArrayParser => {

    let fieldParser: TValueParser<any>;
