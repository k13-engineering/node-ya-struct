import { bitBufferFromUint8Array, createBitBuffer } from "../bit-buffer.ts";
import type { TEndianness } from "../common.ts";
import type { TValueParser } from "./value.ts";

type TIntegerParser = TValueParser<bigint>;

const createIntegerParser = ({ sizeInBits, signed, endianness }: { sizeInBits: number, signed: boolean, endianness: TEndianness }): TIntegerParser => {
